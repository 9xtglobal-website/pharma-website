...
export const SITE_TAGLINE = "Clear-Label Nutraceuticals for Modern Wellness";
...
export const ONLINE_PAYMENT_DISCOUNT = 50; // Rs. off subtotal when paying online
export const COD_HANDLING_FEE = 100; // Rs. added to subtotal for COD/Bank Transfer
